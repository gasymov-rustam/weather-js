...
export const createContent = (data) => {
  ...
  weatherInfoHumidity.append(createWeatherItemTitle('Humidity'), createWeatherItemContent(`${data.main.humidity} %`));

  weatherInfoClouds.append(createWeatherItemTitle('Clouds'), createWeatherItemContent(`${data.clouds.all} %`));
